      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row gap-x-[70px] items-center">
          ...
          <motion.div
            ...
            className="flex flex-col lg:flex-row flex-1 overflow-visible 
            w-full xl:px-20"
          >
            <div className="text-[360px] xl:text-[500px] 2xl:text-[750px]
              leading-none font-tertiary
              lg:tracking-[0.02em] /* Aumentamos tracking */
              px-4 bg-about bg-no-repeat bg-right
              bg-clip-text text-transparent min-w-[500px]"
            >
              01
            </div>
          </motion.div>
